...
const reducer = (state, action) => {
  switch (action.type) {
    ...
    case 'SET-CURRENT-PRODUCT-DETAILS-INFO':
      return {
        ...state,
        currentProductDetailsInfo: action.currentProductDetailsInfo,
      };
    case 'SET-IS-PC':
      return {
        ...state,
        isPc2View: action.isPc2View,
      };
    case 'SET-IS-MIN-SCREEN':
      return {
        ...state,
        isMinScreen: action.isMinScreen,
      }; 
    default:
